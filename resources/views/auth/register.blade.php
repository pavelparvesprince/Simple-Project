                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="browser-default custom-select"; id="payment_type" name="payment_type">
                                    <option selected>---</option>
                                    <option value="1" {{ old('payment_type') == 1 ? 'selected' : '' }}>bKash</option>
                                    <option value="2" {{ old('payment_type') == 2 ? 'selected' : '' }}>Rocket</option>
                                    <option value="3" {{ old('payment_type') == 3 ? 'selected' : '' }}>Nagad</option>
                                </select>
                            </div>
                        </div>
                        ...
                        {{--Payment Number--}}
                        <div class="form-group row">
                            <label for="payment_number" class="col-md-4 col-form-label text-md-right">{{ __('Payment Number') }}</label>

                            <div class="col-md-6">
                                <input id="payment_number" type="text" class="form-control @error('payment_number') is-invalid @enderror" name="payment_number" value="{{ old('payment_number') }}" required autocomplete="payment_number" autofocus>
